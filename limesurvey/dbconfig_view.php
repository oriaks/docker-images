        ...
        <?php endif; ?>
            ...
            <?php
                ...
                $rows[] = array(
                    ...
                    'control' => CHtml::activeDropDownList($model, 'dbtype', $model->supported_db_types, array('value' => 'mysql','required' => 'required', 'class'=>'form-control', 'autofocus' => 'autofocus')),
                ...
                $rows[] = array(
                    ...
                    'control' => CHtml::activeTextField($model, 'dblocation', array('value' => getenv('DB_HOST'),'required' => 'required', 'class' => 'form-control')),
                ...
                $rows[] = array(
                    ...
                    'control' => CHtml::activeTextField($model, 'dbuser', array('value' => getenv('DB_USER'),'required' => 'required','autocomplete'=>'off', 'class' => 'form-control')),
                ...
                $rows[] = array(
                    ...
                    'control' => CHtml::activePasswordField($model, 'dbpwd',array('value' => getenv('DB_PASSWORD'),'autocomplete'=>'off', 'class' => 'form-control')),
                ...
                $rows[] = array(
                    ...
                    'control' => CHtml::activeTextField($model, 'dbname', array('value' => getenv('DB_NAME'),'required' => 'required','autocomplete'=>'off', 'class' => 'form-control')),
                ...
                $rows[] = array(
                    ...
                    'control' => CHtml::activeTextField($model, 'dbprefix', array('value' => getenv('DB_PREFIX'),'autocomplete'=>'off', 'class' => 'form-control')),

...
define('MAIL_FROM', getenv('SMTP_FROM'));

// Mail transport available: "smtp", "sendmail", "mail" (PHP mail function), "postmark", "mailgun", "sendgrid"
define('MAIL_TRANSPORT', 'mail');

// SMTP configuration to use when the "smtp" transport is chosen
define('MAIL_SMTP_HOSTNAME', getenv('SMTP_HOST'));
define('MAIL_SMTP_PORT', 25);
define('MAIL_SMTP_USERNAME', getenv('SMTP_USER'));
define('MAIL_SMTP_PASSWORD', getenv('SMTP_PASSWORD'));
...
define('LDAP_SERVER', getenv('LDAP_HOST'));
...
define('LDAP_USER_BASE_DN', getenv('LDAP_BASE_DN'));

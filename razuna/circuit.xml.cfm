...
<circuit access="public" xmlns:cf="cf/">
	...
	<fuseaction name="first_time_account">
		<!-- Set sessions -->
		<set name="session.firsttime.database" value="mysql" />
		<set name="session.firsttime.database_type" value="mysql" />
		<set name="session.firsttime.db_action" value="create" />
		<set name="session.firsttime.db_name" value="razuna" />
		<set name="session.firsttime.db_pass" value="razuna" />
		<set name="session.firsttime.db_port" value="3306" />
		<set name="session.firsttime.db_schema" value="razuna" />
		<set name="session.firsttime.db_server" value="mysql" />
		<set name="session.firsttime.db_user" value="razuna" />
		<set name="session.firsttime.ecp_path" value="/var/lib/tomcat8/webapps/ROOT/" />
		<set name="session.firsttime.path_assets" value="/var/lib/tomcat8/webapps/ROOT/assets" />
		<set name="session.firsttime.path_dcraw" value="/usr/bin" />
		<set name="session.firsttime.path_exiftool" value="/usr/bin" />
		<set name="session.firsttime.path_ffmpeg" value="/usr/bin" />
		<set name="session.firsttime.path_ghostscript" value="/usr/bin" />
		<set name="session.firsttime.path_im" value="/usr/bin" />
		<set name="session.firsttime.path_mp4box" value="/usr/bin" />
		<set name="session.firsttime.type" value="custom" />
		<!-- Show -->
